...
// user already reserved (id 4, Calista Tan) in design/test-tokens.md's dev-auth
// token list. Needed so Scope C's board_papers/proposals have a valid FK to
// point at. Replace once real registration exists.
//
