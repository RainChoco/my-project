...
// Shared success/error banner state for the three evaluation pages - shows a
// message after each action and auto-dismisses it, per the "show a success or
// error message after each action" requirement.
